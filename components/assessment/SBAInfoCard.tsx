  ...
  if (!snapshot.eligible) {
    return (
      ...
      >
        ...
        <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.6)", lineHeight: 1.5, margin: 0 }}>{snapshot.note}</p>
      </div>
    )
  }
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
        <div
          style={{
            ...
            height: "28px",
            borderRadius: "50%",
            background: "rgba(132,231,165,0.2)",
        ...
        <span style={{ fontSize: "14px", fontWeight: 700, color: "#84e7a5" }}>
          SBA 7(a) Eligible — Wider Buyer Pool
        </span>
      </div>
