...
describe("<HeroConsole />", () => {
  ...
  it("walks the sell path to a result and back", () => {
    ...
    expect(within(done).getByText("You may be ready to begin a full sale process.")).toBeInTheDocument()
    expect(within(done).getByText("Your business is in Heirloom’s core range.")).toBeInTheDocument()
