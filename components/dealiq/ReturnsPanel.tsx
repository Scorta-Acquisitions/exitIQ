...
export function ReturnsPanel({
  ...
  return (
    <div className="dq-screen" style={{ maxWidth: 880 }}>
      ...
      {/* Price & scenario — the model's controls, encased together */}
      <SurfaceCard style={{ marginTop: 24 }}>
        ...
        <div aria-hidden style={{ height: 1, background: "var(--div)", margin: "14px 0 16px" }} />
      ...
      {/* Capital stack */}
      <SurfaceCard tone="soft" style={{ marginTop: 18 }}>
        <section>
          <div
            style={{
              fontFamily: mono,
