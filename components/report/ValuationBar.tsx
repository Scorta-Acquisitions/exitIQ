...
export function ValuationBar({ s1, askingPrice }: ValuationBarProps) {
  ...
  const numericAsk = askingPrice
    ? parseFloat(askingPrice.replace(/[^0-9.]/g, "")) * (askingPrice.toLowerCase().includes("m") ? 1000000 : askingPrice.toLowerCase().includes("k") ? 1000 : 1)
    : null
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "6px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        <div style={{ fontSize: "12px", fontWeight: 600, color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: "0.8px" }}>
          Valuation Methods
        </div>
        {methods.map((method) => {
            ...
            <div key={method.label} style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  <span style={{ fontSize: "13px", fontWeight: 700, color: method.color, fontFamily: "var(--font-space-mono, monospace)" }}>
      ...
      {validAsk && (
        <div style={{
          ...
          <div>
            <div style={{ fontSize: "12px", fontWeight: 600, color: "rgba(255,255,255,0.5)", marginBottom: "2px" }}>Your Asking Price</div>
            <div style={{
