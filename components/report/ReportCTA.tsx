      ...
      {isHot && (
        ...
        >
          ...
          <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6, margin: "0 0 20px" }}>
            Based on your Exit IQ score of {score.composite}, you have a strong foundation for going to market. Connect
            with a verified M&A advisor to validate your price and build your deal package.
          </p>
          <button
            style={{
              background: "#84e7a5",
        ...
        >
          <div
            style={{
              ...
              alignItems: "center",
              gap: "6px",
              background: "rgba(251,189,65,0.15)",
              borderRadius: "1584px",
              padding: "4px 12px",
              fontSize: "11px",
              fontWeight: 700,
          ...
          <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6, margin: "0 0 18px" }}>
            Your 90-day action plan above targets the highest-ROI improvements. Get a free valuation review when
        ...
        >
          <div
            style={{
              ...
              alignItems: "center",
              gap: "6px",
              background: "rgba(193,176,255,0.12)",
              borderRadius: "1584px",
              padding: "4px 12px",
              fontSize: "11px",
              fontWeight: 700,
          ...
          <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6, margin: "0 0 18px" }}>
            We&apos;ll send you market multiples and buyer demand signals for your industry — so you know exactly when
            the timing is right.
          </p>
          <button
            style={{
